...
import superherorobinhoodImage from "../assets/images/superhero/robinhood.jpg";
    ...
    <div>
      <Container>
        ...
        <Row>
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieImage">
              <Image src={superherorobinhoodImage} className="images" />
              <div className="bg-dark ">
                <div className="p-2 m-1 text-white">
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieImage">
              <Image src={spidermanImage} className="images" />
              <div className="bg-dark ">
                <div className="p-2 m-1 text-white">
          ...
          <Col md={4} className="movieWrapper">
            <Card className=" movieImage">
              <Image src={supermanImage} className="images" />
              <div className="bg-dark ">
                <div className="p-2 m-1 text-white">
                  <Card.Title className="text-center">ANT MAN</Card.Title>
                  <Card.Text className="text-left">
